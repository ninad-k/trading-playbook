...
- [[tte]] — Ross's own slide-deck detailing the Traders Trick Entry referenced throughout this book as the preferred early-entry technique.
- [[richard-l-weissman-mechanical-trading-systems]] — for contrast, a fully mechanical/backtested approach to trend continuation versus Ross's discretionary, filter-layered hook method.
- [[michael-covel-trend-following]] — broader trend-following context and track records from other practitioners.
- [[curtis-faith-way-of-the-turtle]] — another discretion-light, breakout-based trend system for comparison against the hook's more pattern-driven entries.
