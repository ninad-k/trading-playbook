---
author: Paul Wilmott, Sam Howison, and Jeff Dewynne
category: Options, Futures & Derivatives
difficulty: advanced
doc_type: book
one_liner: A student-oriented route from random walks and Black–Scholes PDEs to numerical
  and path-dependent option valuation.
pages: 338
related:
- rubinstein-mark-rubinstein-on-derivatives
reviewed_pdf_pages: 1-9, 22, 36, 50, 64, 77, 91, 105, 119, 132, 146, 160, 174, 187,
  201, 215, 229, 242, 256, 270, 284, 297, 311, 325 (every page the scan yields text
  for; the remaining pages are image-only)
slug: 1-the-mathematics-of-financial-derivatives
source_file: 1 The Mathematics Of Financial Derivatives.pdf
