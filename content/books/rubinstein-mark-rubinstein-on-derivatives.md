...
difficulty: advanced
doc_type: book
one_liner: A state-price and replication-based path from forwards and options through
  volatility and dynamic strategies.
pages: 498
related:
- 1-the-mathematics-of-financial-derivatives
- jake-bernstein-how-to-trade-the-new-single-stock-futures
reviewed_pdf_pages: 2-8, 29, 49, 70, 90, 111, 131, 151, 172, 192, 233, 254, 274, 294,
  315, 335, 356, 376, 396, 417, 437, 458, 478 (every page the scan yields text for;
  the remaining pages are image-only)
slug: rubinstein-mark-rubinstein-on-derivatives
source_file: Rubinstein_ Mark - Rubinstein on Derivatives.pdf
...
- hedging
tier: A
title: Rubinstein on Derivatives
year: 1999
---
...
- [[1-the-mathematics-of-financial-derivatives]] — Develops the same pricing domain through stochastic calculus, PDEs, and numerical methods.
- [[jake-bernstein-how-to-trade-the-new-single-stock-futures]] — Applies futures mechanics to a specific retail instrument rather than general valuation theory.
