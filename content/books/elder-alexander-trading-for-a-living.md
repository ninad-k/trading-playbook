...
Trading for a Living is Alexander Elder's foundational text, built around the claim that successful trading rests on three pillars: individual and mass psychology, a technical method for reading the balance of power between bulls and bears, and disciplined money management. Elder, a psychiatrist as well as a trader, draws heavily on his clinical work with addiction (including consulting for a drug-rehabilitation program and lecturing on Alcoholics Anonymous) to argue that undisciplined trading behaves like an addictive disorder. The book moves from psychology, through classical and computerized chart analysis, to Elder's own indicators (Elder-ray, Force Index) and systems (Triple Screen, Parabolic, Channel systems), closing with money management and trade-exit rules.

## Core thesis

Most traders lose not from lack of a good method but from a failure of self-discipline: fear and greed drive impulsive, rule-breaking decisions the same way addictive urges override a substance abuser's judgment. Elder's proposed cure is to treat trading as objectively as possible — quantified technical signals, a written trading plan, a trading diary, and hard position-sizing limits — so that the trader's emotional state cannot override the plan. No single indicator or "holy grail" system is presented as sufficient; the book explicitly frames technical analysis as only one of three pillars, with psychology and money management given equal weight.
...
The **2% Rule** caps risk per trade at 2% of total account equity, including commissions and slippage; Elder frames it as a survival rule that scales trade size automatically — a growing account can trade larger size in dollar terms while keeping the same 2% fraction, and a shrinking account is forced to trade smaller. Pyramiding (adding to a winning trend-following position) is permitted only when the existing position is at breakeven or better and the incremental risk on the addition still satisfies the 2% Rule. Elder singles out the martingale system — doubling size after each loss to "come back" — as psychologically appealing but mathematically ruinous: a losing streak of even a few dozen trades requires bet sizes that exceed any account (and, in his example, the net worth of the entire world), so it is presented as an anti-pattern rather than a rule to adopt. The book does not state the 6% monthly drawdown ceiling that appears in Elder's later work.

## Psychology and discipline

Elder's psychology section opens with the odds against traders (most lose) and builds a case that trading losses mirror addictive behavior: winners on a hot streak start to feel infallible, bend their own rules, and "self-destruct," giving back gains the same way an addict relapses after early sobriety. The insight Elder credits with changing his own trading came from his clinical work with alcoholism and drug rehabilitation, and the book explicitly draws "trading lessons from AA" — chiefly, that recovery requires structure, accountability, and the surrender of the belief that "this time is different." Elder's prescribed discipline: keep a trading diary with before/after chart annotations for every trade, track a spreadsheet including all costs, and hold money-management rules as fixed and non-negotiable rather than adjustable in the moment. He also discusses mass psychology — how crowds behave at market tops and bottoms, and why following market "gurus" is unreliable because a guru's edge decays once a method becomes popular and imitated.
...
Traders who want the original, foundational statement of Elder's three-pillar framework and his core indicators before reading the sequel; well suited to intermediate traders who already understand basic charting and want a psychology-first case for discipline paired with fully specified (if unvalidated) technical rules.

## Related books in this library

- [[come-into-my-trading-room-elder-alexander]] — Elder's own sequel and update: refines Triple Screen's Screen One indicator, adds the Impulse System, SafeZone and Chandelier stops, and formalizes the 2%/6% Rules.
- [[trading-in-the-zone]] — a deeper, dedicated treatment of the trading-psychology material Elder covers more briefly here.
