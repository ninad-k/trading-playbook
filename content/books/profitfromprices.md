...
doc_type: book
one_liner: A rule-based OHLC and volume manual for reversal, continuation, gap, and
  sideways-market signals.
pages: 182
related:
- fractal
- michael-sheimo-stock-market-rules
reviewed_pdf_pages: 1-16, 41-56, 60-62, 80-82, 92-94 (the framework and discipline
  chapters, the signal taxonomy and the U-Turn, Full Stop, weekly-reversal and gap
  specifications)
slug: profitfromprices
source_file: profitfromprices.pdf
