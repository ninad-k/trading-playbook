...
- [[forex-mtpredictor-trading-course-part-1a]] — Part 1 covers the automatic trade set-ups this volume explains and extends.
- [[elliott-waves-principle]] — the foundational wave-counting rules this course applies with added Fibonacci price targets.
- [[fischer-robert-fibonacci-applications-and-strategies-for]] — a deeper, software-independent treatment of the same Fibonacci ratio families used for WPTs.
- [[street-smarts-laurence-connors]] — original source of the 80/20 day set-up adapted in Chapter 10.
- [[gann-w-d-new-stock-trend-detector]] — origin of the minor-pullback observation and the 50%/100% numbers discussed in Chapter 2.
