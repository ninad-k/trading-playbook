...
doc_type: book
one_liner: A systems-development handbook centered on the Adaptive Moving Average
  (KAMA) and a rigorous, skeptical process for testing trading strategies for robustness
  rather than curve-fit profitability.
pages: 257
related:
- perry-kaufman-smarter-trading--adaptive-moving-average-kama
...
reviewed_pdf_pages: 2-4, 32, 40, 250 (contents, cost-of-execution and expectation
  chapters, and the glossary definitions of the efficiency ratio and risk measures)
slug: perry-kaufman-smarter-trading
...
- [[perry-kaufman-smarter-trading--adaptive-moving-average-kama]] — this library's dedicated system page for the KAMA method introduced in Chapter 8.
- [[richard-l-weissman-mechanical-trading-systems]] — complementary coverage of mechanical trend-following system design and testing discipline.
...
- [[van-tharp-trading-systems]] — a complementary framework for position sizing and system evaluation alongside Kaufman's robustness-testing approach.
- [[george-pruitt-building-winning-trading-systems-with-tradestation]] — practical implementation of systematic testing methodology similar in spirit to Kaufman's Part 3.
