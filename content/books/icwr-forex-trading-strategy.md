...
- [[day-trading-the-currency-market]] — a more rigorously documented FX day-trading book with comparable rule-based technical strategies for direct comparison.
- [[elliott-waves-principle]] — the foundational impulsive/corrective wave framework this book's Fibonacci-retracement rules are built on top of.
- [[fischer-robert-fibonacci-applications-and-strategies-for]] — a deeper, more academically grounded treatment of Fibonacci ratios in trading.
- [[forex-systems-research-practical-fibonacci-methods-for-forex-trading-2005]] — another practical Fibonacci-based forex method for cross-reference.
- [[come-into-my-trading-room-elder-alexander]] — useful counterpoint on trade-journaling, discipline, and system validation discipline the ICWR book largely skips.
