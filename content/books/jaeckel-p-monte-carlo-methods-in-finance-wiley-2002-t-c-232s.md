...
difficulty: advanced
doc_type: book
one_liner: An implementation-focused guide to simulation, sampling, variance reduction,
  and convergence in derivatives valuation.
pages: 232
related:
- introduction-to-monte-carlo-methods
- derivatives-pricing-and-financial-modelling
reviewed_pdf_pages: 3-13, 24, 35, 46, 57, 68, 79, 90, 101, 112, 123, 134, 145, 156,
  167, 178, 189, 200, 211, 222 (every page the scan yields text for; the remaining
  pages are image-only)
slug: jaeckel-p-monte-carlo-methods-in-finance-wiley-2002-t-c-232s
source_file: Jaeckel P. Monte-Carlo methods in finance (Wiley_ 2002)(T)(C)(232s).pdf
