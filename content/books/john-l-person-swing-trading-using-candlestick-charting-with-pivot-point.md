...
Self-published promotional booklet (2002) from a broker/newsletter author, illustrated mainly with cherry-picked successful trade examples rather than a systematic backtest; no win-rate or sample size is given. The author explicitly states pivot analysis "is not the holy grail" and that price chart analysis is "an art and not an exact science."

## Who it is for

Futures and forex swing traders who already understand basic charting and want a simple, formula-based way to combine support/resistance levels with candlestick confirmation.
