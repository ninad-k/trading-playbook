...
difficulty: advanced
doc_type: course
one_liner: A workshop handout on nesting weekly, daily, and intraday cycles to time
  swing entries with smaller price risk.
pages: 20
related:
- fractal
- staying-out-of-trouble-trading-currencies-with-channels
reviewed_pdf_pages: 1-20
slug: walter-bressert-intraday-timing-for-low-risk-swing-trading
source_file: Walter Bressert - Intraday Timing For Low Risk Swing Trading.pdf
source_review: full
tags:
- cycles
- swing-trading
...
- timing
tier: A
title: Intraday Timing for Low-Risk Swing Trading
year: 2000
---
...
- [[fractal]] — Explores self-similar market structure from a broader theoretical angle.
- [[staying-out-of-trouble-trading-currencies-with-channels]] — Uses a different form of structure to control entries and exits in currency markets.
