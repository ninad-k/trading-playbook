...
- [[damodaran-aswath-investment-fables]] — same author, applies this toolkit to debunk specific market myths and valuation shortcuts.
- [[the-intelligent-investor-benjamin-graham]] — a simpler, screen-based framework this book's relative-valuation chapters formalize algebraically.
- [[r-g-hagstrom-the-warren-buffett-way-2nd-edition]] — a qualitative, moat-focused companion to this book's quantitative DCF machinery.
- [[j-k-lasser-pick-stocks-like-warren-buffett]] — a more accessible, checklist-driven route to the same fundamental-value question.
