...
1. Trade with the trend; in uptrends buy dips, in downtrends sell bounces.
2. Let profits run and cut losses short; only move stops to lock in gains, never to increase risk.
3. Write a trading plan before entering a position; don't trade impulsively.
4. Target at least a 3-to-1 reward-to-risk ratio.
5. When pyramiding: add only to winning positions, make each added layer smaller than the last, never add to a loser, and move stops to breakeven or better.
6. Be willing to hold a minority position — being right on the market often means disagreeing with the crowd.
7. Keep strategies simple; added complexity doesn't guarantee better results.
...
Complete beginners to forex who want a single reference covering order mechanics, basic charting, an indicator formula glossary, and the economic calendar in one document.
