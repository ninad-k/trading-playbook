...
- [[marcel-petro-market-timing]] — another market-timing-focused text covering complementary calendar/technical timing approaches.
- [[michael-covel-trend-following]] — broader trend-following philosophy and evidence that complements the moving-average crossover systems in Chapter 9.
- [[elder-alexander-trading-for-a-living]] — adds a discretionary technical-analysis and psychology layer to the purely mechanical systems presented here.
- [[jack-schwager-stock-market-wizards]] — trader interviews illustrating the discipline-under-a-losing-streak theme central to Masonson's psychology argument.
- [[joe-ross-trading-spreads-and-seasonals]] — a complementary treatment of seasonal patterns, applied to spreads rather than index timing.
