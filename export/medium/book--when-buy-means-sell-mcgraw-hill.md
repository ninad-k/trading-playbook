# When Buy Means Sell: An Investor's Guide to Investing When It Counts: the trader's summary

*Backtests analyst Buy/Hold/Sell ratings and finds two exploitable lags: sell Strong-Buy stocks on a fixed 6-12 month date instead of waiting for the downgrade, and buy Hold-rated stocks a year after they were downgraded.*

**Eric Shkolnik** · 2003 · Investing, Value & Market History · intermediate

*Source coverage: partial. PDF pages inspected: 4, 11, 13, 22, 108, 165, 168, 170, 172, 181, 183-184, 226 (the screening rules and the backtest tables reporting the strategies' returns). These are study notes, not verified trading results.*
...
The book's tradable content is two related recommendation-based strategies (both are also written up as system sub-pages, [When Buy Means Sell — Strong-Buy Artificial-Maturity Strategy](https://ninad-k.github.io/trading-playbook/books/when-buy-means-sell-mcgraw-hill--strong-buy-artificial-maturity.html) and [When Buy Means Sell — Hold-Rating Reversal Strategy](https://ninad-k.github.io/trading-playbook/books/when-buy-means-sell-mcgraw-hill--hold-rating-reversal.html)):
...
- [Investment Fables: Exposing Myths About Stocks](https://ninad-k.github.io/trading-playbook/books/damodaran-aswath-investment-fables.html) — a far more rigorous version of the same theory-then-portfolio-backtest structure, applied to value and momentum stories rather than analyst ratings.
- [Contrarian Investment Strategies: The Next Generation](https://ninad-k.github.io/trading-playbook/books/david-dreman-contrarian-investment-strategies-the-next-generation.html) — the fuller academic case for buying out-of-favor stocks that this book's Hold-reversal chapter gestures toward.
- [The Triumph of Contrarian Investing: Crowds, Manias, and Beating the Market by Going Against the Grain](https://ninad-k.github.io/trading-playbook/books/mcgraw-hill-the-triumph-of-contrarian-investing-crowds-manias-and-beating-the-market-by-go.html) — another contrarian-investing treatment covering similar overreaction and reversion evidence.
- [Buy the Rumor, Sell the Fact: 85 Maxims of Wall Street and What They Really Mean](https://ninad-k.github.io/trading-playbook/books/mcgraw-hill-buy-the-rumor-sell-the-fact-85-maxims-of-wall-street-and-what-they-really-mean.html) — shares this book's project of decoding Wall Street's stated language versus its actual meaning.
- [Wall Street: How It Works and for Whom](https://ninad-k.github.io/trading-playbook/books/doug-henwood-wall-street-how-it-works.html) — deeper structural background on the brokerage and research-conflict dynamics summarized in Chapters 4 and 8.

---
*Educational summary of ideas from the book, written in my own words. Not financial advice. Please buy the book if these notes are useful.*

More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: analyst-recommendations, regression-to-the-mean, contrarian, wall-street, ipo-avoidance, diversification, artificial-maturity, behavioral-finance
