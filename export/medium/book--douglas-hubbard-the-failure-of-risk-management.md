# The Failure of Risk Management: Why It's Broken and How to Fix It: the trader's summary

*Hubbard argues most corporate/financial risk management — subjective scoring matrices especially — is unvalidated and often worse than no method at all, and prescribes calibrated probabilities plus Monte Carlo modeling as the fix.*

**Douglas W. Hubbard** · 2009 · Quant, Microstructure & Academic Research · intermediate

*Source coverage: partial. PDF pages inspected: 6, 13 and the scoring-method chapters checked against the note. These are study notes, not verified trading results.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: risk-management, monte-carlo, risk-matrices, calibration, black-swans, cognitive-bias, quantitative-methods
