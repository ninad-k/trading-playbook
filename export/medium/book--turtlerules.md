# The Original Turtle Trading Rules: the trader's summary

*The free, original written record of the actual 1983 Turtle rules — N-based unit sizing, System 1/2 breakouts, 2N stops, and unit-adding — released by an Original Turtle.*

**Curtis Faith** · 2003 · Trend Following & Mechanical Systems · intermediate

*Source coverage: full. PDF pages inspected: 1-37. These are study notes, not verified trading results.*
...
See [The Turtle Trading System (Original Rules)](https://ninad-k.github.io/trading-playbook/books/turtlerules--turtle-system.html) for the full, code-ready specification (formulas, entry/stop/exit tables, unit-adding schedule, correlation limits). In summary:
...
This is a primary source, not a secondary summary — it is the closest thing to an authoritative, free written record of the actual rules, corroborated independently by Michael Covel's [The Complete TurtleTrader: The Legend, the Lessons, the Results](https://ninad-k.github.io/trading-playbook/books/the-complete-turtletrader-the-legend-the-lessons-the-results.html) and Curtis Faith's own [Way of the Turtle](https://ninad-k.github.io/trading-playbook/books/curtis-faith-way-of-the-turtle.html). Its dollar examples (heating oil, gold, crude oil) reflect early-2000s prices and contract sizes and need rescaling for current markets. The document itself notes the rules "are not very complicated" but repeatedly stresses that most readers will still fail to trade them profitably, which the document attributes entirely to discipline rather than any gap in the rules — a claim readers should weigh against selection bias in which former Turtles chose to go public with success stories. It offers no formal backtest statistics, drawdown figures, or win-rate data beyond anecdote.

## Who should read it

Traders who want the mechanical Turtle system specified precisely enough to code and backtest, without wading through a memoir or narrative history. It assumes no prior background but rewards readers who also read a narrative account ([Way of the Turtle](https://ninad-k.github.io/trading-playbook/books/curtis-faith-way-of-the-turtle.html) or [The Complete TurtleTrader: The Legend, the Lessons, the Results](https://ninad-k.github.io/trading-playbook/books/the-complete-turtletrader-the-legend-the-lessons-the-results.html)) for the psychological and historical context this document only gestures at.

## Related books in this library

- [The Original Turtle System (Faith's Account)](https://ninad-k.github.io/trading-playbook/books/curtis-faith-way-of-the-turtle--turtle-system.html) — a second, independently written reprint of the same rules from a Turtle who traded them.
- [The Turtle Trading System](https://ninad-k.github.io/trading-playbook/books/the-complete-turtletrader-the-legend-the-lessons-the-results--turtle-trading-system.html) — the rules reconstructed by a journalist from more than 20 Turtle interviews, with career outcomes attached.
- [TurtleTrader.com Site Archive](https://ninad-k.github.io/trading-playbook/books/turtletrader.html) — the commercial site the foreword explicitly criticizes for selling an incomplete version of these same rules.
- [Position-Sizing Effects on Trader Performance: An Experimental Analysis](https://ninad-k.github.io/trading-playbook/books/position-sizing.html) — deeper treatment of the volatility-normalized sizing approach the Turtles pioneered.

---
*Educational summary of ideas from the book, written in my own words. Not financial advice. Please buy the book if these notes are useful.*

More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: turtle-trading, trend-following, breakout, position-sizing, money-management, donchian, futures
