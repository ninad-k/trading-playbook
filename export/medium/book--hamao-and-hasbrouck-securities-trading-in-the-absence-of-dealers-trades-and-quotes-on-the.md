# Securities Trading in the Absence of Dealers: Trades and Quotes on the Tokyo Stock Exchange: the trader's summary

*Academic microstructure study finding that Tokyo Stock Exchange's pure limit-order-book system (no dealers) supplies immediacy nearly as well as dealer markets, using warning/special quotes to slow large orders.*

**Yasushi Hamao, Joel Hasbrouck** · 1995 · Quant, Microstructure & Academic Research · advanced

*Source coverage: partial. PDF pages inspected: 1-2, 4 (the market description, tick-size rules and sample period). These are study notes, not verified trading results.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: market-microstructure, limit-order-book, tokyo-stock-exchange, liquidity, academic, price-limits
