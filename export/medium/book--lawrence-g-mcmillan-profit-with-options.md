# Profit With Options: the trader's summary

*McMillan's applied option-strategy text: reading options as sentiment indicators, selecting strategies by where implied volatility sits versus its own history, and mechanical system trading.*

**Lawrence G. McMillan** · 2002 · Options, Futures & Derivatives · intermediate

*Source coverage: partial. PDF pages inspected: 4-5, 7, 29 (the volatility-percentile methodology chapters and the strategy-selection rules). These are study notes, not verified trading results.*
...
- [The Bible of Options Strategies](https://ninad-k.github.io/trading-playbook/books/guy-cohen-the-bible-of-options-strategies.html) — a broader catalogue of option structures for readers who need the mechanics McMillan assumes as background.
- [The Options Course: High Profit & Low Stress Trading Methods](https://ninad-k.github.io/trading-playbook/books/fontanills-the-options-course-high-profit-and-low-stress-trading-methods-2nd-ed.html) — another applied options strategy text covering similar ground for comparison.
- [Options, Futures, and Other Derivatives (5th Edition)](https://ninad-k.github.io/trading-playbook/books/hull-options-futures-and-other-derivative-securities-5th-ed.html) — the standard academic reference for the option-pricing theory McMillan applies but doesn't derive.
- [The Option Trader Handbook: Strategies and Trade Adjustments](https://ninad-k.github.io/trading-playbook/books/george-m-jabbour-the-option-trader-handbook-strategies-and-trade-adjustments.html) — practical follow-up on adjusting option positions once established, a topic this book only touches on.

---
*Educational summary of ideas from the book, written in my own words. Not financial advice. Please buy the book if these notes are useful.*

More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: options, implied-volatility, straddles, contrary-indicators, put-call-ratio, system-trading, hedging
