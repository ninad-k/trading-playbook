# Financial Mathematics: the trader's summary

*Graduate-level lecture notes deriving derivative pricing from first principles: arbitrage theory, single- and multi-period market models, Black-Scholes, and interest-rate/HJM models.*

**Rüdiger Kiesel** · Quant, Microstructure & Academic Research · advanced

*Source coverage: partial. PDF pages inspected: the four parts' derivation chapters checked against the note; the notes are algebraic and state no trading parameters. These are study notes, not verified trading results.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: arbitrage-theory, derivative-pricing, black-scholes, stochastic-calculus, interest-rate-models, martingale-pricing
