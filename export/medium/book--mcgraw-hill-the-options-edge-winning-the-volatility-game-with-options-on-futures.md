# The Options Edge: Winning the Volatility Game with Options on Futures: the trader's summary

*An empirical, 1996-data-driven study of commodity option pricing that finds no inherent writer's edge, then builds one through defensive straddle writing.*

**William R. Gallacher** · 1999 · Options, Futures & Derivatives · advanced

*Source coverage: partial. PDF pages inspected: 13, 16, 24, 30, 35, 51, 62, 67, 76 (the MAD and market-volatility formulas, the implied-volatility shortcut and the payout-ratio study tables). These are study notes, not verified trading results.*
...
- [Profit With Options](https://ninad-k.github.io/trading-playbook/books/lawrence-g-mcmillan-profit-with-options.html) — a more conventional, strategy-catalog treatment of options that complements Gallacher's single-minded focus on straddle writing.
- [Options, Futures, and Other Derivatives (5th Edition)](https://ninad-k.github.io/trading-playbook/books/hull-options-futures-and-other-derivative-securities-5th-ed.html) — the academic, formula-heavy treatment of the same pricing theory Gallacher spends much of the book arguing against.
- [Using Volatility in Options Trading, Part 1](https://ninad-k.github.io/trading-playbook/books/using-volatility-in-option-tradingpart-1.html) — a shorter, complementary treatment of trading implied versus historical volatility.
- [Using Volatility Information for Trading](https://ninad-k.github.io/trading-playbook/books/volatility-part-2.html) — further practical volatility-trading material to pair with Gallacher's market-volatility formulas.
- [Money Management Strategies for Futures Traders](https://ninad-k.github.io/trading-playbook/books/balsara-nauzer-j-money-management-strategies-for-futures-traders.html) — futures-specific money management to pair with the book's thin treatment of capital allocation across a straddle-writing book.

---
*Educational summary of ideas from the book, written in my own words. Not financial advice. Please buy the book if these notes are useful.*

More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: options-on-futures, volatility, straddle-writing, implied-volatility, option-pricing, defensive-hedging, commodity-options
