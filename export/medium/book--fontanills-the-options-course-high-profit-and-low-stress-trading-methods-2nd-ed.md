# The Options Course: High Profit & Low Stress Trading Methods: the trader's summary

*Full options curriculum built around delta-neutral trading: Greeks, straddles/strangles, ratio backspreads, and range-bound spreads, each with numbered entry/adjustment/exit road maps.*

**George A. Fontanills** · 2005 · Options, Futures & Derivatives · intermediate

*Source coverage: partial. PDF pages inspected: 4, 7-8, 503-511 (contents, the Greeks chapters and the strategy-review appendix with its risk/reward formulas). These are study notes, not verified trading results.*
...
- [Black-Scholes Option Pricing Model](https://ninad-k.github.io/trading-playbook/books/black-scholes-option-pricing-model.html) — the mathematical derivation behind the pricing model this book applies practically (Greeks, IV) without deriving.
- [Introduction to Arbitrage Pricing of Financial Derivatives](https://ninad-k.github.io/trading-playbook/books/introduction-to-arbitrage-pricing-of-financial-derivatives.html) — the no-arbitrage / replicating-portfolio theory underlying the option pricing this book treats as a given software output.
- [Using Options to Buy Stocks: Build Wealth with Little Risk and No Capital](https://ninad-k.github.io/trading-playbook/books/using-options-to-buy-stocks-build-wealth-with-little-risk-and-no-capital.html) — a narrower, single-strategy premium-selling method (short LEAP puts) that shares this book's volatility-selling logic.

---
*Educational summary of ideas from the book, written in my own words. Not financial advice. Please buy the book if these notes are useful.*

More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: options, delta-neutral, greeks, spreads, volatility, ratio-backspread, straddle, money-management
