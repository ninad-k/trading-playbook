# Patterns in Three Centuries of Stock Market Prices: the trader's summary

*Three centuries of London and New York prices suggest horizon-dependent persistence and reversion, but not a demonstrated trading edge.*

**William N. Goetzmann** · 1993 · Quant, Microstructure & Academic Research · advanced

*Source coverage: full. PDF pages inspected: 1-23. These are study notes, not verified trading results.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: market-history, mean-reversion, long-horizon, bootstrapping, stock-returns
