# Does an Electronic Stock Exchange Need an Upstairs Market?: the trader's summary

*Study of 92,170 Paris Bourse block trades finds upstairs (broker-negotiated) markets lower execution costs by tapping unexpressed liquidity and certifying trades as uninformed, even alongside a modern electronic order book.*

**Hendrik Bessembinder, Kumar Venkataraman** · 2002 · Quant, Microstructure & Academic Research · advanced

*Source coverage: partial. PDF pages inspected: 1-4, 6, 14 (the sample description and the upstairs-market volume and cost results). These are study notes, not verified trading results.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: market-microstructure, block-trading, upstairs-market, paris-bourse, execution-costs, academic-research
