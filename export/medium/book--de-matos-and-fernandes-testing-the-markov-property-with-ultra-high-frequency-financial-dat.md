# Testing the Markov Property with Ultra-High Frequency Financial Data: the trader's summary

*Academic paper developing a nonparametric test for whether bid-ask spreads follow a Markov process, rejecting the assumption for 3 of 5 NYSE stocks tested.*

**Joao Amaro de Matos, Marcelo Fernandes** · 2001 · Quant, Microstructure & Academic Research · advanced

*Source coverage: partial. PDF pages inspected: the methodology and results sections checked against the note; the paper reports test statistics rather than trading parameters. These are study notes, not verified trading results.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: market-microstructure, bid-ask-spread, markov-process, nonparametric-testing, academic, nyse, ultra-high-frequency
