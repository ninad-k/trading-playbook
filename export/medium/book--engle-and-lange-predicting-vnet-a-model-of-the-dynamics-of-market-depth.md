# Predicting VNET: A Model of the Dynamics of Market Depth: the trader's summary

*Journal of Financial Markets paper introducing VNET, an event-time measure of realized market depth, and modeling how volume, transaction count, spread, and trading patience predict it on NYSE stocks.*

**Robert F. Engle and Joe Lange** · 2001 · Quant, Microstructure & Academic Research · advanced

*Source coverage: partial. PDF pages inspected: 1, 5, 11 (the VNET definition, the ACD linkage and the 1997 robustness check). These are study notes, not verified trading results.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: academic-paper, market-microstructure, market-depth, liquidity, order-flow, bid-ask-spread
