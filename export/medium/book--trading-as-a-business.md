# Trading As A Business: the trader's summary

*A TradeStation-based framework for building, testing, and money-managing mechanical trading strategies, run like a business rather than traded on prediction.*

**Charlie Wright** · Trend Following & Mechanical Systems · intermediate

*Source coverage: partial. PDF pages inspected: 4, 23, 26, 31, 36, 40-41 (the entry-rule chapters, order-type ranking, T-Bill benchmark and the strategy-evaluation checklist). These are study notes, not verified trading results.*
...
The book teaches a *process* for building a strategy, not one fixed system. Core rules (fully detailed, with worked numbers, in the companion system page [Set-Up and Entry Strategy Design with the ANP Pyramid](https://ninad-k.github.io/trading-playbook/books/trading-as-a-business--set-up-and-entry-with-anp-pyramid.html)):
...
- [Way of the Turtle](https://ninad-k.github.io/trading-playbook/books/curtis-faith-way-of-the-turtle.html) — another fully mechanical trend-following system with an explicit, business-like position-sizing framework.
- [Trend Following](https://ninad-k.github.io/trading-playbook/books/michael-covel-trend-following.html) — broader survey of the trend-following philosophy this book's market-facilitation argument sits within.
- [What Is a Trading System?](https://ninad-k.github.io/trading-playbook/books/van-tharp-trading-systems.html) — a complementary framework for evaluating whether a trading system fits the trader's own psychology and objectives.
- [Special Report on Money Management](https://ninad-k.github.io/trading-playbook/books/money-management-report-van-tharp.html) — alternative position-sizing models to compare against the ANP Pyramid.
- [Mechanical Trading Systems: Pairing Trader Psychology with Technical Analysis](https://ninad-k.github.io/trading-playbook/books/richard-l-weissman-mechanical-trading-systems.html) — a similar mechanical-systems-development approach with additional statistical validation methods.

---
*Educational summary of ideas from the book, written in my own words. Not financial advice. Please buy the book if these notes are useful.*

More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: strategy-development, mechanical-trading, money-management, position-sizing, backtesting, tradestation, trend-following
