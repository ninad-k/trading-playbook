# E.A.S.Y. Trading Method: the trader's summary

*Slide-deck forex system combining Heiken Ashi bars, a price-action channel, and the Traders Dynamic Index (RSI-based) into concrete entry/exit rules.*

**Dean Malone** · 2007 · Indicators · beginner

*Source coverage: partial. PDF pages inspected: 40, 49, 53-54, 85 (the TDI settings and reading rules, entry conditions and the performance table). These are study notes, not verified trading results.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: forex, heiken-ashi, rsi, price-action-channel, traders-dynamic-index, mechanical-system
