# Program Trading and Intraday Volatility: the trader's summary

*NYSE-affiliated researchers find program trades follow (more than lead) S&P 500 price moves and show little reversal, contradicting the claim that program trading destabilizes markets.*

**Lawrence Harris, George Sofianos, James E. Shapiro** · 1994 · Quant, Microstructure & Academic Research · advanced

*Source coverage: partial. PDF pages inspected: 1-3, 9, 11 (the sample description and the price-impact results). These are study notes, not verified trading results.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: program-trading, index-arbitrage, volatility, liquidity, microstructure, s-and-p-500, academic
