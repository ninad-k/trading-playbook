# The Ultimate Trading Guide: the trader's summary

*Futures Truth's founders teach supply/demand chart reading, then walk through building, testing, and money-managing mechanical trading systems.*

**John R. Hill, George Pruitt, Lundy Hill** · 2000 · Trend Following & Mechanical Systems · intermediate

*Source coverage: partial. PDF pages inspected: 3-4, 6-7, 13 (contents, market-stage definitions, the capital allocation model and the case-study entry rules). These are study notes, not verified trading results.*
...
3. **Simple Moving Average Crossover** (backtested 1983-1999): buy when the 13-day MA of closes crosses above the 39-day MA and yesterday's close exceeds the close 40 days back. Stop = 5x the 20-day ATR, trailed 5 ATRs behind price once 5 ATRs of profit accrue. Full rules: [Simple Moving Average Crossover System](https://ninad-k.github.io/trading-playbook/books/j-r-hill-g-pruitt-and-l-hill-the-ultimate-trading-guide--moving-average-crossover-system.html).
4. **Short-Term Volatility Based Open Range Breakout** (Larry Williams-style "buy easier/sell easier"): buy/sell stops set at 50%/100% of the 3-day range from the open, the split set by yesterday's close direction. Stop = 3x the 10-day ATR, moved to breakeven after 3 ATRs profit. Full rules: [Short-Term Volatility Based Open Range Breakout System](https://ninad-k.github.io/trading-playbook/books/j-r-hill-g-pruitt-and-l-hill-the-ultimate-trading-guide--volatility-breakout-system.html).
5. **S&P Day Trade System**: an opening-range breakout plus a counter-trend "key of the day" (H+L+C average) fade; trades only when the 10-day open-to-close range is at least half the 10-day ATR; flat by the close; fixed $300 stop. Full rules: [S&P Day Trade System](https://ninad-k.github.io/trading-playbook/books/j-r-hill-g-pruitt-and-l-hill-the-ultimate-trading-guide--sp-day-trade-system.html).
...
- [Way of the Turtle](https://ninad-k.github.io/trading-playbook/books/curtis-faith-way-of-the-turtle.html) — another mechanical trend-following system built and tested the way Futures Truth evaluates vendor systems.
- [TurtleTrader.com Site Archive](https://ninad-k.github.io/trading-playbook/books/turtletrader.html) — the original Donchian-breakout rules this book's channel discussion draws on.
- [Building Winning Trading Systems with TradeStation](https://ninad-k.github.io/trading-playbook/books/george-pruitt-building-winning-trading-systems-with-tradestation.html) — co-author George Pruitt's dedicated guide to coding and testing systems.
- [Trading for a Living](https://ninad-k.github.io/trading-playbook/books/elder-alexander-trading-for-a-living.html) — a psychology- and money-management-forward counterpart to this book's mechanical, backtest-driven approach.
- [Elliott Wave Principle](https://ninad-k.github.io/trading-playbook/books/elliott-waves-principle.html) — the source theory behind Chapter 2's trading-oriented condensation.

---
*Educational summary of ideas from the book, written in my own words. Not financial advice. Please buy the book if these notes are useful.*

More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: chart-patterns, mechanical-systems, money-management, backtesting, swing-trading, wyckoff, elliott-wave, futures
