# Trade Stocks and Commodities with the Insiders: Secrets of the COT Report: the trader's summary

*Builds a COT Index from the CFTC's Commitments of Traders report to gauge commercial hedgers' relative bullishness, and combines it with a trend filter into a complete trading method.*

**Larry Williams** · 2005 · Trend Following & Mechanical Systems · intermediate

*Source coverage: partial. PDF pages inspected: 3, 5, 7, 20, 22 (contents, the COT report structure, and the Public/Commercial index threshold rules). These are study notes, not verified trading results.*
...
**Commercial COT Index thresholds:** above 80% (3-year lookback) marks unusually heavy commercial buying and favors rallies; below 20% marks unusually heavy selling and favors declines. Williams stresses the index shows *what*, not *when* — it needs a trend filter (see the system sub-page, [The One-Minute Commodity Trader](https://ninad-k.github.io/trading-playbook/books/williams-larry-trade-stocks-and-commodities-with-the-insiders--one-minute-commodity-trader.html)).
...
- [TurtleTrader.com Site Archive](https://ninad-k.github.io/trading-playbook/books/turtletrader.html) — another trend-following futures framework; useful contrast between price-only trend rules and Williams' trend-plus-positioning approach.
- [What Is a Trading System?](https://ninad-k.github.io/trading-playbook/books/van-tharp-trading-systems.html) — a general framework for defining and evaluating a trading system's components, applicable to formalizing the One-Minute Commodity Trader method.
- [The Dynamic Break Out II Strategy](https://ninad-k.github.io/trading-playbook/books/dynamic-breakout-ii-strategy.html) — an alternative mechanical trend-filter (adaptive Donchian breakout) that could substitute for the 52-week moving-average filter used here.

---
*Educational summary of ideas from the book, written in my own words. Not financial advice. Please buy the book if these notes are useful.*

More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: cot-report, commitments-of-traders, commercials, contrarian, futures, sentiment, trend-filter, smart-money
