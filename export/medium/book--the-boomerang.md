# The Boomerang: NipThePips' Trading Method: the trader's summary

*A GBP/USD or GBP/JPY H4 breakout system that flips direction and widens its take-profit target after each 5-pip stop-out, aiming to eventually catch the real move.*

**NipThePips** · 2008 · Forex Mechanics & Macro Drivers · intermediate

*Source coverage: partial. PDF pages inspected: 4, 9, 11, 13 (the rule set, the scale-out schedule and the worked trade sequences). These are study notes, not verified trading results.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: forex, breakout, martingale, reverse-and-reset, compounding, gbpusd, gbpjpy
