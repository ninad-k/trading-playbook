# The Knife (Sundial System): the trader's summary

*Forex momentum system (nicknamed 'the Knife') combining weekly moving-average momentum for trend and 4-hour moving-average slope changes for entries, with Fibonacci profit targets.*

**Charles "Diallist" (James16 trading forum)** · Forex Mechanics & Macro Drivers · intermediate

*Source coverage: partial. PDF pages inspected: 4, 7 (the moving-average settings and the primary/secondary signal rules). These are study notes, not verified trading results.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: forex, momentum, moving-averages, fibonacci, position-sizing, trend-following, mechanical-system
