# Liquidity in the Forward Exchange Market: the trader's summary

*Journal of Empirical Finance paper building a limited-participation two-country model to explain spot-return autocorrelation, forward-discount persistence, and the forward bias puzzle via a liquidity 'wedge.'*

**Michael J. Moore and Maurice J. Roche** · 2001 · Quant, Microstructure & Academic Research · advanced

*Source coverage: partial. PDF pages inspected: 7-11 (the calibration parameters and the model comparison results). These are study notes, not verified trading results.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: academic-paper, forward-exchange-rate, liquidity, cash-in-advance-model, forward-discount-puzzle, macro
