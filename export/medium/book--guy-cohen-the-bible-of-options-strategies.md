# The Bible of Options Strategies: the trader's summary

*A 58-strategy options reference giving construction, Greeks, risk/reward, and exit rules for every strategy from a long call to iron condors and synthetics.*

**Guy Cohen** · 2005 · Options, Futures & Derivatives · intermediate

*Source coverage: partial. PDF pages inspected: 5, 16, 47-48, 51 (the strategy taxonomy and the per-strategy selection filters for liquidity, open interest and expiration). These are study notes, not verified trading results.*
...
- [The Options Course: High Profit & Low Stress Trading Methods](https://ninad-k.github.io/trading-playbook/books/fontanills-the-options-course-high-profit-and-low-stress-trading-methods-2nd-ed.html) — another broad options-strategy course, useful for cross-checking construction rules and adding volatility-trading theory Cohen omits.
- [Profit With Options](https://ninad-k.github.io/trading-playbook/books/lawrence-g-mcmillan-profit-with-options.html) — deeper treatment of position adjustment and dynamic management, the gap this book's own "awkward to adjust" caveats point to.
- [The Option Trader Handbook: Strategies and Trade Adjustments](https://ninad-k.github.io/trading-playbook/books/george-m-jabbour-the-option-trader-handbook-strategies-and-trade-adjustments.html) — focused specifically on adjusting existing option positions, complementing this book's static construction-only approach.
- [Options, Futures, and Other Derivatives (5th Edition)](https://ninad-k.github.io/trading-playbook/books/hull-options-futures-and-other-derivative-securities-5th-ed.html) — the options-pricing and Greeks-mechanics theory this book assumes but never derives.
- [The Equity Options Strategy Guide](https://ninad-k.github.io/trading-playbook/books/the-equity-options-strategy-guide.html) — a shorter, complementary strategy reference for cross-checking risk/reward formulas on the same core strategy set.

---
*Educational summary of ideas from the book, written in my own words. Not financial advice. Please buy the book if these notes are useful.*

More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: options, spreads, straddles-strangles, iron-condors, synthetics, greeks, income-strategies, taxation
