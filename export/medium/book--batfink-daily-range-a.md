# BatFink Daily Range (A): the trader's summary

*Mechanical GBP/USD intraday-range breakout system entering 40 pips from the daily close, with staged profit targets and trailing stops, backtested May-Oct 2006.*

**MarkJ** · 2006 · Day Trading & Scalping · intermediate

*Source coverage: partial. PDF pages inspected: 4-8 (the entry-line construction, target ladder and the per-pair results tables). These are study notes, not verified trading results.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: forex, day-trading, daily-range, mechanical-system, gbp-usd, trailing-stop, backtest
