# Understanding Gaps: the trader's summary

*Statistical framework for fading the opening gap in S&P 500 futures using gap size, zone, seasonality, stop, and target data.*

**Scott Andrews** · 2008 · Day Trading & Scalping · intermediate

*Source coverage: partial. PDF pages inspected: 3, 6, 19-22 (the gap-zone statistics, the fade results and the monthly breakdowns). These are study notes, not verified trading results.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: gap-trading, gap-fade, s-p-500-futures, day-trading, statistics, stop-loss, target-optimization
