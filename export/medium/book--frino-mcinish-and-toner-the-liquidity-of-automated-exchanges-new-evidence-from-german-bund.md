# The Liquidity of Automated Exchanges: New Evidence from German Bund Futures: the trader's summary

*An academic study finds bid-ask spreads on the automated DTB were narrower than on floor-traded LIFFE for German Bund futures in 1997, contradicting older research.*

**Alex Frino, Thomas H. McInish, Martin Toner** · 1998 · Quant, Microstructure & Academic Research · advanced

*Source coverage: partial. PDF pages inspected: 10, 12 (the descriptive-statistics and regression tables). These are study notes, not verified trading results.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: market-microstructure, liquidity, bid-ask-spread, futures, automated-trading, open-outcry, academic
