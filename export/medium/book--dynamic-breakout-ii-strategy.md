# The Dynamic Break Out II Strategy: the trader's summary

*A Donchian-style breakout system that adapts its look-back length daily to market volatility, adding a Bollinger Band filter and dynamic trailing stop.*

**George Pruitt, John R. Hill** · 2002 · Trend Following & Mechanical Systems · intermediate
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: breakout, donchian-channel, volatility, adaptive-parameters, bollinger-bands, trend-following, seasonality
