# The Forex Chartist Companion: the trader's summary

*A catalog of forex-specific charting techniques (activity, P&F, swing charts, Goodman Swing Count) rather than a trading system, heavy on statistics and light on money management.*

**Michael D. Archer, James L. Bickford** · 2007 · Market Structure & Price Action · intermediate

*Source coverage: partial. PDF pages inspected: 5, 7-8, 10, 143-144 (contents, the 50 percent principle and Goodman swing count chapters, and the Fibonacci retracement rules). These are study notes, not verified trading results.*
...
- [Bollinger on Bollinger Bands](https://ninad-k.github.io/trading-playbook/books/john-bollinger-bollinger-on-bollinger-band.html) — another chart-pattern-driven approach with its own statistical validation, useful contrast in rigor and scope.
...
- [Trend Following](https://ninad-k.github.io/trading-playbook/books/michael-covel-trend-following.html) — supplies the systematic money-management and psychology content this book omits.
- [High Probability Trading Strategies](https://ninad-k.github.io/trading-playbook/books/miner-robert-high-probability-trading-strategies-entry-to-exit-tactics-for-the-forex-futur.html) — a Fibonacci/Elliott-oriented forex and futures method that overlaps with this book's swing-chart Fibonacci chapters.
- [The Wyckoff Method of Trading Stocks](https://ninad-k.github.io/trading-playbook/books/s-and-c--wyckoff-method.html) — another pattern/price-structure school (accumulation, distribution, support/resistance) that complements the P&F chapter's support/resistance framing.

---
*Educational summary of ideas from the book, written in my own words. Not financial advice. Please buy the book if these notes are useful.*

More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: point-and-figure, swing-charts, chart-patterns, forex, fibonacci, elliott-wave, price-objectives
