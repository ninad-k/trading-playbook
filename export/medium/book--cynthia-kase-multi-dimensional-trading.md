# Multi-dimensional Time Trading: the trader's summary

*Explains rolling higher-timeframe permission filters and KaseCD as a companion to the proprietary PeakOscillator.*

**Cynthia Kase** · 1996 · Indicators · advanced

*Source coverage: full. PDF pages inspected: 1-3; all rendered pages inspected visually. These are study notes, not verified trading results.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: multi-timeframe, stochastic, kase, divergence, volatility
