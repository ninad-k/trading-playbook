# Surfing the Market Waves: Jan Arps' Swing Trader's Toolkit: the trader's summary

*TradeStation/SuperCharts toolkit manual defining a full set of swing-trading indicators — Zig-Zag, Fox Wave, Fib channels, Andrews Pitchfork, Price Magnets, and three Radar oscillators.*

**Jan L. Arps** · 1998 · Swing Trading · intermediate

*Source coverage: partial. PDF pages inspected: 2, 13-14, 23 (the indicator construction, ratio settings and the support/resistance rules). These are study notes, not verified trading results.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: swing-trading, elliott-wave, fibonacci, andrews-pitchfork, zig-zag, support-resistance, oscillators
