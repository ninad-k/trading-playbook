# Re-examining the Small-Cap Myth: Problems in Portfolio Formation and Liquidation: the trader's summary

*Intraday simulation shows small-cap turn-of-the-year outperformance largely disappears once real order-book liquidity constraints replace the assumption of instant execution.*

**Mark D. Griffiths, D. Alasdair S. Turnbull, Robert W. White** · 1999 · Quant, Microstructure & Academic Research · advanced

*Source coverage: partial. PDF pages inspected: 1, 5, 8, 12, 17 (the trading-cost methodology and the small-cap-versus-large-cap results). These are study notes, not verified trading results.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: small-cap, turn-of-the-year-effect, liquidity, portfolio-formation, transaction-costs, academic-paper
