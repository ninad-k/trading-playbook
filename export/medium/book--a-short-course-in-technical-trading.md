# A Short Course in Technical Trading: the trader's summary

*A graduate-course walkthrough of trend, momentum, and volatility indicators with worked spreadsheet formulas, backtest tables, and explicit trading rules.*

**Perry J. Kaufman** · 2003 · Trend Following & Mechanical Systems · beginner

*Source coverage: partial. PDF pages inspected: 5, 7-8, 10, 15, 23, 74-77, 84 (the regression-slope and moving-average system chapters with their backtest tables). These are study notes, not verified trading results.*
...
8. **Percentage price bands.** Upper band = 20-day MA × 1.05; lower band = 20-day MA / 1.05 (or × 0.95). Buy near the lower band, sell near the upper band, exit near the middle; works best in slow, sideways markets and fails badly in sustained trends (see [Bollinger Band System](https://ninad-k.github.io/trading-playbook/books/a-short-course-in-technical-trading--bollinger-band-system.html)).
...
- [Trading for a Living](https://ninad-k.github.io/trading-playbook/books/elder-alexander-trading-for-a-living.html) — complements Kaufman's indicator mechanics with a fuller psychology and money-management framework (the 2% rule).
- [Way of the Turtle](https://ninad-k.github.io/trading-playbook/books/curtis-faith-way-of-the-turtle.html) and [The Complete TurtleTrader: The Legend, the Lessons, the Results](https://ninad-k.github.io/trading-playbook/books/the-complete-turtletrader-the-legend-the-lessons-the-results.html) — both build on the same N-day breakout / volatility-sizing logic Kaufman introduces, taken to a fully mechanical system.
- [Special Report on Money Management](https://ninad-k.github.io/trading-playbook/books/money-management-report-van-tharp.html) — deeper treatment of the position-sizing-by-volatility idea Kaufman sketches in Chapter 17.
- [Street Smarts: High Probability Short-Term Trading Strategies](https://ninad-k.github.io/trading-playbook/books/street-smarts-laurence-connors.html) — a more short-term, pattern-driven counterpart to Kaufman's oscillator chapters (stochastic, RSI).

---
*Educational summary of ideas from the book, written in my own words. Not financial advice. Please buy the book if these notes are useful.*

More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: moving-average, breakout, momentum, macd, stochastic, rsi, volatility, position-sizing
