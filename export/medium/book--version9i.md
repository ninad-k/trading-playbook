# Stealth Forex System: Trading Methodology: the trader's summary

*The trading-rules manual for the proprietary 'Stealth Forex' system, covering four sub-strategies (Simple, Scalper, Mission, Creamer) built on custom LCD and Stealth buy/sell indicators.*

**Unknown** · Day Trading & Scalping · beginner

*Source coverage: partial. PDF pages inspected: 2, 7-8 (the news filter and the three systems' entry, stop and trailing rules). These are study notes, not verified trading results.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: forex, scalping, proprietary-indicators, money-management, metatrader, multi-timeframe
