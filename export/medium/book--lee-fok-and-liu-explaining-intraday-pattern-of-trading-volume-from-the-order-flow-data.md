# Explaining Intraday Pattern of Trading Volume from the Order Flow Data: the trader's summary

*Taiwan Stock Exchange order-book data shows a J-shaped (not U-shaped) intraday volume pattern, driven more by liquidity flow than informed trading.*

**Yi-Tsung Lee, Robert C.W. Fok, Yu-Jane Liu** · 2001 · Quant, Microstructure & Academic Research · advanced

*Source coverage: partial. PDF pages inspected: 1-4 (the market structure, sample period and hypotheses). These are study notes, not verified trading results.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: order-flow, trading-volume, intraday-patterns, market-microstructure, information-asymmetry, academic-paper
