# Options and Options Trading: A Simplified Course: the trader's summary

*Builds option pricing from coin-toss probability up through the Black-Scholes formula, then argues no strategy is an automatic winner and the real edge is order flow, customer business, and reading volatility.*

**Robert W. Ward** · 2004 · Options, Futures & Derivatives · beginner

*Source coverage: partial. PDF pages inspected: 3-4, 25, 27-29, 36, 71, 75 (moneyness and Greeks definitions, the binomial chapters and the conversion/reversal mechanics). These are study notes, not verified trading results.*
...
- [Black-Scholes Option Pricing Model](https://ninad-k.github.io/trading-playbook/books/black-scholes-option-pricing-model.html) — the formal derivation of the same Black-Scholes formula this book approaches intuitively through coin-toss probability.
- [The Options Course: High Profit & Low Stress Trading Methods](https://ninad-k.github.io/trading-playbook/books/fontanills-the-options-course-high-profit-and-low-stress-trading-methods-2nd-ed.html) — picks up where this book's Greeks chapter leaves off, with numbered entry/adjustment/exit road maps for delta-neutral strategies this book only surveys conceptually.
- [Options, Futures, and Other Derivatives (5th Edition)](https://ninad-k.github.io/trading-playbook/books/hull-options-futures-and-other-derivative-securities-5th-ed.html) — the rigorous academic derivative-pricing text this book is a simplified, narrative on-ramp to.

---
*Educational summary of ideas from the book, written in my own words. Not financial advice. Please buy the book if these notes are useful.*

More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: options, black-scholes, binomial-model, greeks, delta-hedging, volatility, probability, derivatives
