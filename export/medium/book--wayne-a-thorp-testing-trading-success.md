# How to Test and Interpret Trading System Performance: the trader's summary

*AAII Journal article showing, with a worked 20-year example, how commissions, slippage, margin, stops and idle interest each swing a mechanical system's reported returns.*

**Wayne A. Thorp** · 2001 · Quant, Microstructure & Academic Research · intermediate
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: backtesting, system-testing, optimization, slippage, commissions, money-management-stops
