# Options: Essential Concepts and Trading Strategies: the trader's summary

*CBOE Options Institute textbook covering option fundamentals, the Greeks and volatility, a strategy-by-strategy analysis framework, small-investor and institutional applications, and floor market-making.*

**The Options Institute (Chicago Board Options Exchange)** · 1995 · Options, Futures & Derivatives · intermediate

*Source coverage: partial. PDF pages inspected: 4-5, 182 and the strategy-selection chapters checked against the note's claims (Greeks definitions, VIX range, strategy-selection framework). These are study notes, not verified trading results.*
...
- [The Options Course: High Profit & Low Stress Trading Methods](https://ninad-k.github.io/trading-playbook/books/fontanills-the-options-course-high-profit-and-low-stress-trading-methods-2nd-ed.html) — another broad options-strategy reference, useful for cross-checking strategy definitions and risk profiles.
- [The Bible of Options Strategies](https://ninad-k.github.io/trading-playbook/books/guy-cohen-the-bible-of-options-strategies.html) — a strategy-by-strategy options reference to compare against this book's opinion/selection framework.
- [Options, Futures, and Other Derivatives (5th Edition)](https://ninad-k.github.io/trading-playbook/books/hull-options-futures-and-other-derivative-securities-5th-ed.html) — the standard quantitative derivatives text, useful as the mathematical complement to this book's non-mathematical treatment of the Greeks and volatility.
- [Profit With Options](https://ninad-k.github.io/trading-playbook/books/lawrence-g-mcmillan-profit-with-options.html) — a practitioner-oriented options strategy book for comparing selection criteria and real-world position management.
- [Stock Options and the New Rules of Corporate Accountability](https://ninad-k.github.io/trading-playbook/books/mcgraw-hill-stock-options-and-the-new-rules.html) — another options strategy reference for cross-referencing strategy mechanics.

---
*Educational summary of ideas from the book, written in my own words. Not financial advice. Please buy the book if these notes are useful.*

More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: options, greeks, volatility, spreads, covered-call, market-making, institutional
