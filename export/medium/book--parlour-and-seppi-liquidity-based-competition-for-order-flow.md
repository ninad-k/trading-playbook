# Liquidity-Based Competition for Order Flow: the trader's summary

*Theoretical model of exchange competition showing that neither a pure limit-order market nor a hybrid specialist/limit-order market is inherently 'competition-proof' for order flow.*

**Christine A. Parlour, Duane J. Seppi** · 2003 · Quant, Microstructure & Academic Research · advanced

*Source coverage: partial. PDF pages inspected: the model and results sections checked against the note; the paper is analytical rather than numeric. These are study notes, not verified trading results.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: market-microstructure, limit-order-book, liquidity, order-preferencing, specialist-market, academic-paper
