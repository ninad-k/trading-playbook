# The FxOverEasy System: the trader's summary

*A two-page 15-minute forex system requiring three confirming signals (channel slope, two oscillator crossovers, a volatility filter) before entry, using non-standard custom indicators.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: forex, channel-trading, custom-indicators, scalping, 15-minute-chart
