# Introduction to Monte Carlo Methods: the trader's summary

*General-purpose scientific-computing primer on Monte Carlo simulation and probability theory, with physics examples; contains no finance or trading content.*

**Computational Science Education Project** · Quant, Microstructure & Academic Research · advanced

*Source coverage: partial. PDF pages inspected: 4 and the method sections checked against the note; the tutorial's worked example is physical rather than financial. These are study notes, not verified trading results.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: monte-carlo, simulation, probability, statistics, numerical-methods, random-sampling
