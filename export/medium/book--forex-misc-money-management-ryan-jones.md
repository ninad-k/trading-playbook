# The Trading Game: Playing by the Numbers to Make Millions: the trader's summary

*Introduces Fixed Ratio position sizing (the delta formula) and mathematically dismantles Fixed Fractional and Optimal f sizing as its rivals.*

**Ryan Jones** · 1999 · Money Management & Position Sizing · intermediate

*Source coverage: partial. PDF pages inspected: 1, 7, 10-11 (the opening argument for money management, the asymmetrical-leverage arithmetic and the fixed-fractional critique). These are study notes, not verified trading results.*
...
- [Money Management Strategies for Futures Traders](https://ninad-k.github.io/trading-playbook/books/balsara-nauzer-j-money-management-strategies-for-futures-traders.html) — covers Optimal f and risk of ruin in more statistical depth; a useful counterpoint to Jones's dismissal of Fixed Fractional.
- [Way of the Turtle](https://ninad-k.github.io/trading-playbook/books/curtis-faith-way-of-the-turtle.html) — the Turtles used a related but distinct volatility-based (N/ATR) sizing approach; a good contrast in philosophy and mechanics.
- [The Complete TurtleTrader: The Legend, the Lessons, the Results](https://ninad-k.github.io/trading-playbook/books/the-complete-turtletrader-the-legend-the-lessons-the-results.html) — another antimartingale, volatility-scaled sizing method built into a complete trading system.
- [Special Report on Money Management](https://ninad-k.github.io/trading-playbook/books/money-management-report-van-tharp.html) — Van Tharp's broader definition of position sizing, including the fixed-fractional variants Jones critiques.
- [Position-Sizing Effects on Trader Performance: An Experimental Analysis](https://ninad-k.github.io/trading-playbook/books/position-sizing.html) — a shorter treatment of the same core sizing problem, useful for comparison.

---
*Educational summary of ideas from the book, written in my own words. Not financial advice. Please buy the book if these notes are useful.*

More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: money-management, position-sizing, fixed-ratio, fixed-fractional, futures, risk-of-ruin, drawdown-control
