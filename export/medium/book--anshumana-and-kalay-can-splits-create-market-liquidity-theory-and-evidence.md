# Can Splits Create Market Liquidity? Theory and Evidence: the trader's summary

*Journal of Financial Markets (2002) model and NYSE evidence arguing firms split their stocks to reach an optimal price level that maximizes liquidity by inducing traders to concentrate their trades in time, given fixed minimum tick sizes.*

**V. Ravi Anshuman and Avner Kalay** · 2002 · Quant, Microstructure & Academic Research · advanced

*Source coverage: partial. PDF pages inspected: 2, 10, 30-33, 37, 43 (the model, the data description and the empirical results). These are study notes, not verified trading results.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: stock-splits, market-microstructure, liquidity, tick-size, academic-paper, trading-volume
