# Information Sharing, Liquidity and Transaction Costs in Floor-Based Trading Systems: the trader's summary

*Theoretical model of floor brokers pooling fundamental and order-flow information, showing it improves price discovery and cuts liquidity traders' costs but can raise or lower market depth.*

**Thierry Foucault and Laurence Lescourret** · 2001 · Quant, Microstructure & Academic Research · advanced

*Source coverage: partial. PDF pages inspected: 4, 6-7 (the model setup and the information-sharing results). These are study notes, not verified trading results.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: market-microstructure, floor-trading, information-sharing, liquidity, bid-ask-spread, academic-paper
