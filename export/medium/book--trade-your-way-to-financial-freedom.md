# Trade Your Way to Financial Freedom: the trader's summary

*Defines trading expectancy and R-multiples, then shows through backtested examples that position sizing (not entry signals) drives most of a system's real-world return.*

**Van K. Tharp** · 1998 · Money Management & Position Sizing · intermediate

*Source coverage: partial. PDF pages inspected: 1-4, 9, 14, 18, 22, 28, 34, 81, 112, 121, 275-290 (the expectancy arithmetic, position-sizing models and the system-development chapters). These are study notes, not verified trading results.*
...
- [What Is a Trading System?](https://ninad-k.github.io/trading-playbook/books/van-tharp-trading-systems.html) — a shorter Tharp article covering the same trading-system-as-business-plan territory at a higher level; this book fully develops the expectancy and position-sizing concepts it references.
- [Special Report on Money Management](https://ninad-k.github.io/trading-playbook/books/money-management-report-van-tharp.html) — Tharp's dedicated money-management report, a natural next read after this book's position-sizing chapter.
- [Way of the Turtle](https://ninad-k.github.io/trading-playbook/books/curtis-faith-way-of-the-turtle.html) — a fully disclosed trend-following system whose percent-risk-based sizing can be evaluated directly against Tharp's four models.
- [Building Winning Trading Systems with TradeStation](https://ninad-k.github.io/trading-playbook/books/george-pruitt-building-winning-trading-systems-with-tradestation.html) — supplies complete entry/exit systems of the kind Tharp's Chapter 5 surveys only conceptually.

---
*Educational summary of ideas from the book, written in my own words. Not financial advice. Please buy the book if these notes are useful.*

More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: expectancy, r-multiples, position-sizing, system-development, trading-psychology, money-management
