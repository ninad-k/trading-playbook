# The Stock Trader: How I Make a Living Trading Stocks: the trader's summary

*A real-time, 116-trade trading diary from the April 2000 Nasdaq crash showing a long-only support/resistance day-trading system, its scan formulas, and every stop and target used.*

**Tony Oz** · 2000 · Day Trading & Scalping · beginner

*Source coverage: partial. PDF pages inspected: 1, 3, 5, 7, 9, 15, 21, 132 (the scan definitions with their volume and price filters, and the trade-diary chapters). These are study notes, not verified trading results.*
...
- [Stock Market Wizards](https://ninad-k.github.io/trading-playbook/books/jack-schwager-stock-market-wizards.html) — interview-format complement covering how other short-term and swing traders think about risk and discipline.
- [Reminiscences of a Stock Operator](https://ninad-k.github.io/trading-playbook/books/reminiscences-of-a-stock-operator-by-edwin-lefevre-to-jesse-livermore.html) — Oz's own recommended reading; a classic narrative on speculation psychology that pairs with this book's real-time diary format.
- [Trading for a Living](https://ninad-k.github.io/trading-playbook/books/elder-alexander-trading-for-a-living.html) — a more systematic treatment of the psychology, method, and money-management triad this diary illustrates anecdotally.
- [Come Into My Trading Room](https://ninad-k.github.io/trading-playbook/books/come-into-my-trading-room-elder-alexander.html) — another day-in-the-life-style trading text with a similar diary/case-study structure.
- [Charting Made Easy](https://ninad-k.github.io/trading-playbook/books/john-j-murphy-charting-made-easy.html) — a more thorough treatment of the chart patterns (double tops/bottoms, triangles) Oz references only briefly via his glossary.

---
*Educational summary of ideas from the book, written in my own words. Not financial advice. Please buy the book if these notes are useful.*

More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: support-resistance, day-trading, scanning, level-ii, risk-reward-ratio, trading-diary, nasdaq
