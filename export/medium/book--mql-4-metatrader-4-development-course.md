# MQL4 - MetaTrader 4 Development Course: the trader's summary

*Free web-published MQL4 tutorial series covering syntax through building a first custom indicator, Expert Advisor, and script in MetaTrader 4.*

**Coders' Guru** · 2006 · Trend Following & Mechanical Systems · intermediate

*Source coverage: partial. PDF pages inspected: 9-10 and the lesson chapters checked against the note's description of the language and examples. These are study notes, not verified trading results.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: mql4, metatrader, expert-advisor, custom-indicator, automation, programming
