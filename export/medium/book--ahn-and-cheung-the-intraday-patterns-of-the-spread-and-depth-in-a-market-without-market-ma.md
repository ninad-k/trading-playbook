# The Intraday Patterns of the Spread and Depth in a Market Without Market Makers: The Stock Exchange of Hong Kong: the trader's summary

*Empirical study of 471 Hong Kong stocks finding U-shaped intraday/intraweek spreads and reverse-U-shaped depth, proving these patterns arise from limit-order traders alone, without any specialist market maker.*

**Hee-Joon Ahn and Yan-Leung Cheung** · 1999 · Quant, Microstructure & Academic Research · advanced

*Source coverage: partial. PDF pages inspected: 7-9, 16-17 (the descriptive statistics and the spread/depth correlation tables). These are study notes, not verified trading results.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: market-microstructure, bid-ask-spread, market-depth, limit-order-book, liquidity, adverse-selection, academic-paper
