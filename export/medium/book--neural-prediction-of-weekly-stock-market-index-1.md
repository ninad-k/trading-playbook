# Application of Neural Networks to Stock Market Prediction: the trader's summary

*A feedforward neural network using detrended S&P 500 history plus lagged interest rates predicts next week's index one week ahead, tested on the 1987 crash and 1994 bull run.*

**Amol S. Kulkarni** · 1996 · Quant, Microstructure & Academic Research · advanced

*Source coverage: partial. PDF pages inspected: 2, 5, 8-9, 12-14, 16 (the network design, the test results and the error statistics). These are study notes, not verified trading results.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: neural-networks, backpropagation, s-and-p-500, interest-rates, academic, forecasting, quant
