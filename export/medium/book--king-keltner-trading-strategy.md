# The King Keltner Trading Strategy: the trader's summary

*A 1960s Chester Keltner moving-average-band breakout system, modernized with a true-range channel and a moving-average liquidation stop.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: keltner-channel, moving-average, true-range, trend-following, breakout, futures
