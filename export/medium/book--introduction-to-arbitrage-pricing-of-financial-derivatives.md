# Introduction to Arbitrage Pricing of Financial Derivatives: the trader's summary

*Lecture-note derivation of no-arbitrage option pricing via replicating portfolios and martingale measures, from a one-period binomial model up through futures markets.*

**Marek Rutkowski** · 1997 · Options, Futures & Derivatives · advanced

*Source coverage: partial. PDF pages inspected: 2-3, 10 (the binomial worked example and the replication argument). These are study notes, not verified trading results.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: arbitrage-pricing, options, binomial-model, martingale, risk-neutral-valuation, replicating-portfolio, academic-reference
