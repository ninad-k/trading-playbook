# 241 Forex: Trading Systems Built to Change and Adapt to the Trader: the trader's summary

*Two rule-based forex systems (weekly Swing Trade Equation and daily Intraday Trade Equation) with three risk tiers of entries, stops, and pip targets.*

**Carl (241Forex.com)** · 2006 · Forex Mechanics & Macro Drivers · intermediate

*Source coverage: partial. PDF pages inspected: 2-3, 10 (the contents, trader tiers and the swing-system rules with the worked trade table). These are study notes, not verified trading results.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: forex, swing-trading, intraday, weekly-pivots, position-sizing, trend-following
