# Stock Market Analysis Using the SAS System: Portfolio Selection and Evaluation: the trader's summary

*A Version 6 SAS applications manual for return measurement, valuation, portfolio optimization, CAPM, and options.*

**SAS Institute Inc.** · Quant, Microstructure & Academic Research · advanced

*Source coverage: partial. PDF pages inspected: 1-18, 26, 36, 46, 55, 65, 75, 85, 94, 104, 114, 124, 133, 143, 153, 163, 172, 182, 192, 202, 211, 217-230 (every page the scan yields text for; the remaining pages are image-only). These are study notes, not verified trading results.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: sas, portfolio-analysis, capm, optimization, discounted-cash-flow, options
