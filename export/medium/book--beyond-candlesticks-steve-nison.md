# Beyond Candlesticks: New Japanese Charting Techniques Revealed: the trader's summary

*Nison's follow-up to Japanese Candlestick Charting Techniques adds the disparity index and three under-translated Japanese charting styles: three-line break, renko, and kagi.*

**Steve Nison** · 1994 · Candlesticks & Chart Patterns · intermediate

*Source coverage: partial. PDF pages inspected: 8-11, 22-23, 31, 39-40 (contents, the disparity index and moving-average chapters, and the three-line break/renko/kagi construction rules). These are study notes, not verified trading results.*
...
5. Full construction and signal rules: [The Disparity Index](https://ninad-k.github.io/trading-playbook/books/beyond-candlesticks-steve-nison--disparity-index.html), [Three-Line Break Charts](https://ninad-k.github.io/trading-playbook/books/beyond-candlesticks-steve-nison--three-line-break-chart.html), [Renko Charts](https://ninad-k.github.io/trading-playbook/books/beyond-candlesticks-steve-nison--renko-chart.html), [Kagi Charts](https://ninad-k.github.io/trading-playbook/books/beyond-candlesticks-steve-nison--kagi-chart.html).
...
- [Introduction to Candlesticks](https://ninad-k.github.io/trading-playbook/books/trading-hill-arthur-introduction-to-candlesticks.html) — a shorter primer covering the same core candle patterns this book's Part One restates.
- [Candlestick Charting Explained](https://ninad-k.github.io/trading-playbook/books/greg-morris-candlestick-charting-explained.html) — an alternative, statistics-oriented treatment of the same candlestick pattern set.
- [Candlestick Charting Explained](https://ninad-k.github.io/trading-playbook/books/candlestick-charting-explained.html) — another candlestick reference for cross-checking pattern definitions and reliability claims.
- [Swing Trading Using Candlestick Charting with Pivot Point Analysis](https://ninad-k.github.io/trading-playbook/books/john-l-person-swing-trading-using-candlestick-charting-with-pivot-point.html) — applies candlestick signals (as this book recommends) within a broader trend/pivot framework for entries.

---
*Educational summary of ideas from the book, written in my own words. Not financial advice. Please buy the book if these notes are useful.*

More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: candlesticks, disparity-index, three-line-break, renko, kagi, moving-averages, japanese-charting
