# Black-Scholes Option Pricing Model: the trader's summary

*A step-by-step mathematical derivation of the Black-Scholes PDE and its closed-form solution for a European call option.*

**Nathan Coelen** · 2002 · Options, Futures & Derivatives · advanced

*Source coverage: partial. PDF pages inspected: the derivation sections checked against the note; the paper is algebraic rather than numeric. These are study notes, not verified trading results.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: options-pricing, black-scholes, stochastic-calculus, brownian-motion, derivatives, academic-paper
