# The Econometrics of Ultra-High Frequency Data: the trader's summary

*Engle models irregular transaction arrivals with conditional durations and links IBM trade timing to instantaneous quote volatility.*

**Robert F. Engle** · 1996 · Quant, Microstructure & Academic Research · advanced

*Source coverage: full. PDF pages inspected: 1-19. These are study notes, not verified trading results.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: high-frequency-data, acd, transaction-duration, volatility
