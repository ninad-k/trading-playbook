# The New Technical Trader: Boost Your Profit by Plugging Into the Latest Indicators: the trader's summary

*Introduces VIDYA, Qstick, the Chande Momentum Oscillator, StochRSI, Market Thrust, and a volatility-based (Chande Kroll) stop, with backtested trading rules for each.*

**Tushar S. Chande and Stanley Kroll** · 1994 · Indicators · intermediate

*Source coverage: partial. PDF pages inspected: 6, 12, 15, 22, 25, 29, 39, 45, 49, 52, 55, 62, 65, 75, 92, 102, 109 (indicator construction and trading-rule pages for VIDYA, Qstick, CMO/StochRSI, Market Thrust and the volatility stop). These are study notes, not verified trading results.*
...
- [Smarter Trading](https://ninad-k.github.io/trading-playbook/books/perry-kaufman-smarter-trading.html) — another adaptive/volatility-indexed moving-average approach, useful for comparing against VIDYA's design.
- [Trend Determination: A Quick, Accurate, and Effective Methodology](https://ninad-k.github.io/trading-playbook/books/john-hayden-how-to-use-the-rsi.html) — background on standard RSI, the base indicator StochRSI and CMO are built to improve on.
- [Measuring Internal Strength: Wilder's RSI Indicator](https://ninad-k.github.io/trading-playbook/books/wayne-a-thorp-measuring-internal-strength-wilders-rsi-indicator.html) — further RSI background relevant to the StochRSI and CMO chapters.
- [Special Report on Money Management](https://ninad-k.github.io/trading-playbook/books/money-management-report-van-tharp.html) — a useful companion on position sizing, since this book's risk chapter focuses on stop placement rather than sizing formulas.

---
*Educational summary of ideas from the book, written in my own words. Not financial advice. Please buy the book if these notes are useful.*

More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: momentum, moving-average, volatility, stops, oscillators, mechanical-system
