# Managing Credit Risk with Credit and Macro Derivatives: the trader's summary

*An academic banking-theory paper deriving optimal hedge rules for a risk-averse bank using credit default swaps and macro derivatives to hedge loan-portfolio credit risk.*

**Udo Broll, Gerhard Schweimayer & Peter Welzel** · 2003 · Quant, Microstructure & Academic Research · advanced

*Source coverage: partial. PDF pages inspected: the three separation cases and the macro-derivative section checked against the note; the paper is analytical rather than numeric. These are study notes, not verified trading results.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: credit-risk, credit-default-swap, macro-derivatives, hedging, banking-theory, academic-research
