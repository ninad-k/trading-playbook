# Automated Intraday Open Pivot Setup: the trader's summary

*A spreadsheet-driven forex system that compares the daily pivot point to the previous session's open to pick direction, then trades a fixed 20-pip limit/20-pip stop, best tested on GBP/USD.*

**Jeff Reimer** · 2005 · Day Trading & Scalping · beginner
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: forex, pivot-points, intraday, spreadsheet-system, money-management, gbpusd
