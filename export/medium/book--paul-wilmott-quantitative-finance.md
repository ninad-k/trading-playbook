# Paul Wilmott Introduces Quantitative Finance: the trader's summary

*A gentle, discursive intro to quant finance: products and no-arbitrage, option jargon and payoff diagrams, then a skeptical tour of technical analysis and market microstructure.*

**Paul Wilmott** · 2001 · Quant, Microstructure & Academic Research · intermediate

*Source coverage: partial. PDF pages inspected: 1-11, 43, 59, 70 (products/markets front matter, the speculation-and-gearing worked example, and the technical-analysis chapter checked against the note's claims). These are study notes, not verified trading results.*
...
- [Rubinstein on Derivatives](https://ninad-k.github.io/trading-playbook/books/rubinstein-mark-rubinstein-on-derivatives.html) — covers the same no-arbitrage and payoff-diagram territory in more depth, plus the binomial model and Black-Scholes derivation this sample doesn't reach.
- [Options, Futures, and Other Derivatives (5th Edition)](https://ninad-k.github.io/trading-playbook/books/hull-options-futures-and-other-derivative-securities-5th-ed.html) — the standard, more comprehensive derivatives textbook Wilmott himself cites as one of "the best books on options."
- [Black-Scholes Option Pricing Model](https://ninad-k.github.io/trading-playbook/books/black-scholes-option-pricing-model.html) — a focused treatment of the pricing model this introductory text sets up but does not derive in the sampled chapters.
- [Chart Formations](https://ninad-k.github.io/trading-playbook/books/chart-formations.html) — a deeper dive into the chart patterns Wilmott surveys briefly and skeptically in Chapter 3.

---
*Educational summary of ideas from the book, written in my own words. Not financial advice. Please buy the book if these notes are useful.*

More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: quantitative-finance, derivatives, options, no-arbitrage, black-scholes, technical-analysis, market-microstructure
