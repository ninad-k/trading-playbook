# Streetsmart Guide to Valuing a Stock: the trader's summary

*A four-step discounted free-cash-flow-to-the-firm procedure for estimating a stock's intrinsic value, worked through real 2002-2003 companies.*

**Gary Gray, Patrick J. Cusatis, J. Randall Woolridge** · 2004 · Investing, Value & Market History · intermediate

*Source coverage: partial. PDF pages inspected: 6, 10, 37, 41 (contents, the DCF framework, cost-of-capital inputs and the residual-value share of total value). These are study notes, not verified trading results.*
...
This is a valuation framework, not a trading system, so "setups" here means the repeatable four-step procedure (fully detailed as a checklist in the companion system page [The FCFF Valuation Checklist](https://ninad-k.github.io/trading-playbook/books/streetsmart-guide-to-valuing-a-stock--fcff-valuation-checklist.html)):
...
- [Investment Valuation](https://ninad-k.github.io/trading-playbook/books/investment-valuation-damodaran.html) — the deeper, more rigorous academic treatment of the same DCF/FCFF machinery this book condenses into a practitioner checklist.
- [The Intelligent Investor](https://ninad-k.github.io/trading-playbook/books/the-intelligent-investor-benjamin-graham.html) — the classical value-investing foundation (margin of safety, Mr. Market) that motivates the buy-below/sell-above intrinsic-value rule used here.
- [The Warren Buffett Way](https://ninad-k.github.io/trading-playbook/books/r-g-hagstrom-the-warren-buffett-way-2nd-edition.html) — a complementary qualitative lens (moat, management quality) for judging which "excess return period" bucket (1-5-7-10) a company belongs in.
- [Investment Fables: Exposing Myths About Stocks](https://ninad-k.github.io/trading-playbook/books/damodaran-aswath-investment-fables.html) — a useful counterweight that stress-tests common valuation shortcuts and misconceptions this book's checklist approach can encourage.
- [Asset Valuation & Allocation Models](https://ninad-k.github.io/trading-playbook/books/asset-valuation-allocation-models.html) — another cost-of-capital and valuation-modeling resource for cross-checking WACC and CAPM assumptions.

---
*Educational summary of ideas from the book, written in my own words. Not financial advice. Please buy the book if these notes are useful.*

More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: valuation, dcf, fundamental-analysis, wacc, free-cash-flow, capm, stock-picking
