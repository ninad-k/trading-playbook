# Currency Hedging in Fixed Income Portfolios: the trader's summary

*Lehman Brothers research note on how FX forward hedges change a bond portfolio's duration and create tracking error versus hedged benchmarks.*

**Lev Dynkin, Tony Gould** · 2003 · Forex Mechanics & Macro Drivers · advanced

*Source coverage: partial. PDF pages inspected: 6-9 (the hedging-mechanics sections and the index weight/return tables). These are study notes, not verified trading results.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: currency-hedging, fixed-income, forward-contracts, duration, tracking-error, index-replication, institutional
