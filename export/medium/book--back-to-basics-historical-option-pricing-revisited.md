# Back to Basics: Historical Option Pricing Revisited: the trader's summary

*Physicists Bouchaud and Potters re-derive option pricing from historical (not risk-neutral) probability using a risk-minimization framework, and show the resulting volatility smile matches real BUND option data.*

**Jean-Philippe Bouchaud, Marc Potters** · 1999 · Options, Futures & Derivatives · advanced

*Source coverage: partial. PDF pages inspected: 1, 5, 8 (the residual-risk result, the empirical Bund-future study and the model assumptions). These are study notes, not verified trading results.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: option-pricing, black-scholes, volatility-smile, kurtosis, risk-minimization, academic-research
