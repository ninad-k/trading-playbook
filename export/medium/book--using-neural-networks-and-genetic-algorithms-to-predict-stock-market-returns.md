# Using Neural Networks and Genetic Algorithms to Predict Stock Market Returns: the trader's summary

*MSc thesis testing whether autoregressive and neural-network models can predict daily FTSE/S&P excess returns; neither beats naive random-walk benchmarks.*

**Efstathios Kalyvas** · 2001 · Quant, Microstructure & Academic Research · advanced

*Source coverage: partial. PDF pages inspected: 6, 11 and the results chapters checked against the note's benchmark findings. These are study notes, not verified trading results.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: neural-networks, genetic-algorithms, stock-prediction, autoregressive, academic-research, efficient-markets
