# Overnight Information and Intraday Trading Behavior: Evidence from NYSE Cross-Listed Stocks and Their Local Market Information: the trader's summary

*Academic study finding NYSE opening-hour volatility in foreign cross-listed stocks tracks overnight local-market returns, but opening trading volume does not.*

**Kalok Chan, Mark Chockalingam, Kent W.L. Lai** · 2000 · Quant, Microstructure & Academic Research · advanced

*Source coverage: partial. PDF pages inspected: 1, 3, 6, 8-9, 35 (the sample construction and the interval-by-interval regression results). These are study notes, not verified trading results.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: market-microstructure, intraday-volatility, overnight-returns, cross-listed-stocks, academic-research, opening-volatility
