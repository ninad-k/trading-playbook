# A Theory of Intraday Patterns: Volume and Price Variability: the trader's summary

*A market-microstructure model showing why liquidity and informed traders both concentrate their trading in the same intraday period, producing the classic U-shaped volume/volatility curve.*

**Anat R. Admati and Paul Pfleiderer** · 1988 · Quant, Microstructure & Academic Research · advanced

*Source coverage: partial. PDF pages inspected: 1-2 and the propositions checked against the note's summary of the model. These are study notes, not verified trading results.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: market-microstructure, liquidity-trading, informed-trading, volume, u-shape, academic-paper
