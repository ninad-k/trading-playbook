# Bunny Cross System: the trader's summary

*A forum thread compiling one forex trader's WMA5/WMA20 crossover system for EUR/USD, GBP/USD and USD/CHF on 30-minute charts, with a pip-filter entry and multi-lot scale-out exits.*

**Lester** · Forex Mechanics & Macro Drivers · intermediate
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: forex, moving-average-cross, wma, scalping, trailing-stop, scaling-out, eur-usd
