# Historical Testing: the trader's summary

*FX Engines' Core Concepts brief on using historical (backtest) data to assess a system's risk before trading it live, and the five main ways backtests mislead.*

**Scott Owens** · 2005 · Trend Following & Mechanical Systems · beginner

*Source coverage: partial. PDF pages inspected: 2-3 (the analysis and optimization sections; the remainder is product marketing). These are study notes, not verified trading results.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: backtesting, curve-fitting, drawdown, forex, system-optimization, risk-assessment
