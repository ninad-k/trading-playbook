# ATrainer Method: the trader's summary

*A forum-posted breakout system combining a 1-period MA, a standard-deviation-based moving-average envelope, and DMI (+DI/-DI) crossovers, tuned for 20-pip EUR/USD gains.*
...
More notes like this: [https://ninad-k.github.io/trading-playbook/](https://ninad-k.github.io/trading-playbook/) · Tags: moving-average-envelope, dmi, forex, breakout, discretionary-system, eur-usd
